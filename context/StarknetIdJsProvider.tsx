...
export const StarknetIdJsProvider: FunctionComponent<Context> = ({children}) => {
   ...
   const starknetIdNavigator = useMemo(() => {
      return new StarknetIdNavigator(provider, isTestnet ? constants.StarknetChainId.SN_SEPOLIA : constants.StarknetChainId.SN_MAIN);
   }, [provider, isTestnet]);
   ...
   return <StarknetIdJsContext.Provider value={contextValues}>{children}</StarknetIdJsContext.Provider>;
};
